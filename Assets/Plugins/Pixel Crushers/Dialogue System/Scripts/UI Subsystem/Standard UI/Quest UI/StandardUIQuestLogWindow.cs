...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class StandardUIQuestLogWindow : QuestLogWindow
    {
        ...
        protected StandardUIInstancedContentManager selectionPanelContentManager { get; set; }
        protected StandardUIInstancedContentManager detailsPanelContentManager { get; set; }
        ...
        public override void OnQuestListUpdated()
        {
            ...
            if (quests.Length > 0)
            {
                ...
                {
                    if (IsSelectedQuest(quest)) RepaintSelectedQuest(quest);
