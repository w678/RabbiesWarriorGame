...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class DialogueSystemController : MonoBehaviour
    {
        ...
        private void InitializeLocalization()
        {
            ...
            if (!string.IsNullOrEmpty(displaySettings.localizationSettings.language) ||
                displaySettings.localizationSettings.textTable != null)
            {
                if (m_uiLocalizationManager == null) m_uiLocalizationManager = gameObject.AddComponent<UILocalizationManager>();
                if (m_uiLocalizationManager.textTable == null) m_uiLocalizationManager.textTable = displaySettings.localizationSettings.textTable;
                m_uiLocalizationManager.currentLanguage = displaySettings.localizationSettings.language;
                Localization.language = displaySettings.localizationSettings.language;                
            }
        }
