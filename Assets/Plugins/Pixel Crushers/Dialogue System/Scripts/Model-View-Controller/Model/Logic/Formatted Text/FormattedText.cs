...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class FormattedText
    {
        ...
        public FormattedText(string text = null, Emphasis[] emphases = null, bool italic = false, int position = NoAssignedPosition, bool forceMenu = true, bool forceAuto = false,
                             int pic = NoPicOverride, int picActor = NoPicOverride, int picConversant = NoPicOverride, string variableInputPrompt = null, int subtitlePanelNumber = -1)
        {
        ...
        public static FormattedText Parse(string rawText, EmphasisSetting[] emphasisSettings = null)
        {
            ...
            return new FormattedText(text, emphases, italic, position, forceMenu, forceAuto, pic, pica, picc, variableInputPrompt, subtitlePanelNumber);
        }
